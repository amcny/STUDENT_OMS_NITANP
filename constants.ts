...
export const STUDENTS_STORAGE_KEY = 'outing_management_students';
export const OUTING_LOGS_STORAGE_key = 'outing_management_logs';
export const VISITOR_LOGS_STORAGE_KEY = 'visitor_management_logs';
export const GATE_STORAGE_KEY = 'outing_management_gate';
...
export const YEAR_OPTIONS = ['I', 'II', 'III', 'IV'];
export const GENDER_OPTIONS = ['Male', 'Female'];
export const STUDENT_TYPE_OPTIONS = ['Hosteller', 'Day-Scholar'];
